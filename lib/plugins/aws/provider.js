      ...
      serverless.configSchemaHandler.defineProvider('aws', {
        definitions: {
          ...
          awsCfBase64: {
            type: 'object',
            properties: {
              'Fn::Base64': { type: 'string', minLength: 1 },
            },
            required: ['Fn::Base64'],
            additionalProperties: false,
          },
            ...
            properties: {
              'Fn::FindInMap': {
                ...
                items: {
                  oneOf: [
                    { type: 'string', minLength: 1 },
                    // Note: FindInMap allows use of itself but definition here causes memory leak
              ...
              'Fn::Split': {
                ...
                items: {
                  oneOf: [
                    ...
                    { $ref: '#/definitions/awsCfIf' },
                    { $ref: '#/definitions/awsCfImportValue' },
                    { $ref: '#/definitions/awsCfJoin' },
                    { $ref: '#/definitions/awsCfSelect' },
                    { $ref: '#/definitions/awsCfSub' },
                    { $ref: '#/definitions/awsCfRef' },
          ...
          awsCfSub: {
            ...
            properties: {
              'Fn::Sub': {
                ...
                minItems: 1,
                maxItems: 2,
                items: [{ type: 'string', minLength: 1 }, { type: 'object' }],
              },
            },
            required: ['Fn::Sub'],
            additionalProperties: false,
          ...
          properties: {
            ...
            httpApi: {
              ...
              properties: {
                ...
                id: {
                  anyOf: [{ type: 'string' }, { $ref: '#/definitions/awsCfImport' }],
                },
                name: { type: 'string' },
                payload: { type: 'string' },
                metrics: { type: 'boolean' },
